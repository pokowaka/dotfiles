return {
	...
	--  },
	--
	-- Let's enable some gemini
	{
		"olimorris/codecompanion.nvim",
		lazy = false, -- Load explicitly
		opts = {
			strategies = {
				chat = { adapter = "gemini" }, -- Update to gemini-cli when this is released: https://github.com/google-gemini/gemini-cli/pull/13646
